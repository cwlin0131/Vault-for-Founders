...
7. 當 memory-summary.md 超過 50 行，讀 [memory-scaling.md](zh/memory-scaling.md)，協助使用者拆分為兩層記憶架構
...
│   ├── memory-scaling.md     ← Memory scaling guide
