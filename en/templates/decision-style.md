...
## Discussion Flow (work through with your AI)

### Layer 1: Default mode

Pick one statement that feels closest to your default:

- "I evaluate thoroughly, then move fast once I decide."
...
### Layer 2: Where you get stuck

What kinds of decisions reliably stall you?

- Cold-starting an unfamiliar domain
- Decisions where the cost of being wrong is high but reversible
- Decisions where the data is ambiguous and "wait for more data" feels safer than choosing
...
### Layer 4: How your AI should respond to you

Now that the AI knows how you decide, what should it *do* with that knowledge?

- When you're stuck on cold-start: should it break the task down into the smallest first step? Should it suggest the dumbest possible MVP?
- When you're over-researching: should it explicitly call it out? Or just nudge with "do you have enough to choose now?"
- When you're moving too fast on intuition: should it slow you down, or trust you?

This is where the file becomes a *behavior contract*, not just self-description.

---

## Format

There's no required structure, but here's a useful skeleton once you've worked through the discussion:
...
## Default mode
[1-2 sentences capturing your default decision pattern, with evidence from a real recent example]

### What the AI should notice
- [Behavior pattern 1 the AI should watch for]
- [Behavior pattern 2]
- [How the AI should respond when it sees this pattern]

---

## Quality bar
[Where you sit on maximalist ↔ pragmatist axis, and the constraint that defines "good enough" for you]
...
*Don't aim for a complete file on day one. Aim for one sentence per section that's specific enough to be useful. Iterate.*
